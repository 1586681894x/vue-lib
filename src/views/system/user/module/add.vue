...
<script>
    ...
    methods: {
      ...
      formSubmit: function() {
          this.$refs.form.validate().then((res)=>{
              ...
              //
              this.api('user.add',data).then(response => {
  ...
  function getColumns(){
      ...
      return [
          {name:'username',text:'登陆名称',type:'input'},
          {size:12},
          {name:'password',text:'密码',type:'input',hide:false,props:{type:'password'}},
          {name:'confirmPasswd',text:'确认密码',type:'input',hide:false,props:{type:'password'}},
