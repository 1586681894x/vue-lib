...
//             name: 'Menu',
//             meta: { title: '菜单', icon: 'tree-table' }
//         },
//         {
//             path: 'role',
//             component: (resolve) => require(['@/views/system/role'], resolve),
//             name: 'Role',
//             meta: { title: '权限', icon: 'tree-table' }
//         }
//     ]
// },
  {
  ...
  {
    path: '/404',
    component: (resolve) => require(['@/views/dashboard/404'], resolve),
    hidden: true
  },
  {
    path: '/401',
    component: (resolve) => require(['@/views/dashboard/401'], resolve),
    hidden: true
  },
  {
    path: '/user',
